...
\begin{document}
	\begin{sansmath}
		...
		\node[task7,minimum width=2.5*\ux, 
		...
		\node[task7, minimum width=1.25*\ux,
		...
		\node[task7, minimum width=1.25*\ux,
		anchor=south west] at (9.5, 0){\tiny $C_2^2$};
		\node[task7, minimum width=1.25*\ux,
		anchor=south west] at (11, 0){\tiny $C_2^1$};
