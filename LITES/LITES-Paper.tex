...
\subjclass{Real-time systems, Real-time schedulability, Synchronization}% mandatory: Please choose 2012 ACM classifications from http://www.acm.org/about/class/2012 . E.g., cite as "Integrated circuits". 
\keywords{period enforcer, deferred execution, self-suspension, blocking}% mandatory: Please provide 1-5 keywords
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
