...
This report revisits the \emph{period enforcer} algorithm proposed by Rajkumar \cite{Raj:suspension1991} to handle self-suspending real-time tasks. We briefly review the period enforcer algorithm, explain its underlying assumptions and limitations, and discuss how it may be analyzed to correctly determine the schedulability of self-suspending sporadic real-time tasks subject to period enforcement. 

The main contributions of this paper are two observations that have not been previously reported in the real-time literature:
